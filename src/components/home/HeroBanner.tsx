        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="max-w-2xl animate-scale-in">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 text-shadow-lg">
              Откройте для себя <span className="text-gradient">новый мир</span> игрового опыта
            </h1>
            <p className="text-lg md:text-xl text-white/80 mb-8">
              Погрузитесь в захватывающий экшен, невероятные приключения и сражения 
              с уникальными противниками в нашей новой игре.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-game-primary hover:bg-game-primary/90 text-white font-medium text-lg animate-pulse-glow">
