        ...
        if (newProgress >= 100) {
          ...
          setTimeout(() => {
            ...
            toast({
              ...
              description: "Спасибо за скачивание! Установите игру и приступайте к приключениям.",
            });
          }, 500);
          return 100;
        }
    ...
    <div className="py-16 md:py-24 bg-game-dark" id="download">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Готовы начать приключение?</h2>
          <p className="text-lg text-white/80 mb-8">
            Скачайте игру прямо сейчас и погрузитесь в захватывающий мир приключений, 
            сражений и открытий. Присоединяйтесь к тысячам игроков по всему миру!
          </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
              <div className="flex items-center gap-4">
                <div className="rounded-full w-14 h-14 bg-game-primary/20 flex items-center justify-center">
                  <Icon name="GameController" className="h-7 w-7 text-game-primary" />
                </div>
                <div className="text-left">
                  <h3 className="text-xl font-semibold text-white">Игра "Звездный Странник"</h3>
          ...
          <div className="mt-8 flex justify-center gap-8">
            <a href="#" className="text-white/70 hover:text-white transition-colors flex flex-col items-center">
