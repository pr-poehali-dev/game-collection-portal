        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Icon name="Rocket" className="h-6 w-6 text-game-primary" />
              <span className="font-bold text-xl text-white">GamePortal</span>
            </div>
            <p className="mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Скоро выйдут</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Рекомендуемые</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Все игры</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Проблемы со скачиванием</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Для прессы</a></li>
